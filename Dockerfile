...
ENV APP_CONFIG_IP_ROOT=https://live-code-be-2.ript.vn
ENV APP_CONFIG_IP_JUDGE0=https://judge0.ript.vn
ENV APP_CONFIG_IP_AI_SERVICE=https://aiservice1.ptit.edu.vn/v1
...
ENV APP_CONFIG_CO_QUAN_CHU_QUAN='CodeLab'
ENV APP_CONFIG_TEN_TRUONG='CodeLab'
ENV APP_CONFIG_TIEN_TO_TRUONG='Học viện'
ENV APP_CONFIG_TEN_TRUONG_VIET_TAT_TIENG_ANH=CODELAB
ENV APP_CONFIG_PRIMARY_COLOR="#007EB9"

ENV APP_CONFIG_URL_LANDING=https://smartcom.vn/
...
ENV APP_CONFIG_TITLE_NHAN_SU='CodeLab'
