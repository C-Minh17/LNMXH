...
export const formatISOToVietnamTime = (
	...
	try {
		return dayjs(isoString).tz('Asia/Ho_Chi_Minh').format(format);
	} catch (error) {
...
export const formatISOToVietnamDate = (isoString: string | null | undefined): string => {
	return formatISOToVietnamTime(isoString, 'DD/MM/YYYY');
};
