...
import { Button, Card, Col, Form, Input, InputNumber, Modal, Row, Tag, theme, Tooltip, Typography } from "antd"
...
const StatisticHighschoolGraduationDetail = () => {
  ...
  return (
    <>
      ...
      <Card
        title={<span style={{ color: token.colorPrimary }}>Thống kê tốt nghiệp THPT</span>}
      ...
      >
        <TableStaticData
          ...
          hasTotal
          onReload={() => handleStatisticHighschoolGraduationDetail(params)}
          otherButtons={[
            <>
