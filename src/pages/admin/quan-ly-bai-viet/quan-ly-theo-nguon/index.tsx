...
const ManagePosts = () => {
  const { refreshKey, postFilterDataTypeV1, postFilterDataTypeV1Loading, handlePostFilterDataTypeV1, handleDeletePostV2, dataType, handleGetDataTypePostV2 } = useModel("manage-post.manage-post")
  ...
  useEffect(() => {
    handlePostFilterDataTypeV1(valueDataType)
  ...
  return (
    <>
      ...
      <TableStaticData
        columns={columns}
        data={postFilterDataTypeV1 || []}
        addStt={true}
        hasTotal
        loading={postFilterDataTypeV1Loading}
      // hasCreate
      // setShowEdit={() => {
      //   setMethodForm("post")
