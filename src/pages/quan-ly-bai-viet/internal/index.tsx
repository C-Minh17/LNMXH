...
import FormPostV2 from "../external/components/form"
import FormFilterParams from "../external/components/formFilter"
...
const ManagePosts = () => {
  ...
  useEffect(() => {
    handlePostFilterDocumentType("internal", params)
